...
jQuery(document).ready(function ($) {
    ...
    jQuery('a.poplight').click(function () {
        ...
        jQuery('#' + popID).fadeIn().css({'width': Number(popWidth)}).prepend('<a href="#" class="close"><img src="/contents/lib/eventsplus/images/btn-close.png" class="btn_close" title="Close Window" alt="Close" /></a>');
